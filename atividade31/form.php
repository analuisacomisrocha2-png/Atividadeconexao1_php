...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js" integrity="sha384-FKyoEForCGlyvwx9Hj09JcYn3nv7wiPVlz7YYwJrWVcXK/BmnVDxM+D2scQbITxI" crossorigin="anonymous"></script>
    ...
    <link rel="stylesheet" href="./css/styele5.css">
...
<body>
    <form action="./enviar_funcionario.php" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="livro">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Ano da Publicacao:</label>
            <input type="number" class="form-control" id="exampleInputPassword1" name="ano da publicacao">
        </div>
        <div class="mb-3">
