...
<body>
    <form action="./listar_eventos.php" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" name="local">
        </div>
         <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Vagas:</label>
            <input type="number" class="form-control" id="exampleInputEmail1" name="vagas">
        </div>
